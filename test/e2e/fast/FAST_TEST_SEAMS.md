...
| `purchasing-supply-and-receipt.spec.ts` | Purchasing creates expected supply, receipt converts it into physical stock, and explicit PO edits clear additional costs without reviving legacy shipping. |
