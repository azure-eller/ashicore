...
| Field | Type | Default | Description |
| --- | --- | --- | --- |
| Ingredient | item reference | recipe component | Component item copied from the current product recipe, swapped to an active same-family variant, or added as a one-off line. |
