...
- **Delete guards** mean a record can't vanish from under *active* work — you can't [delete a supplier](/docs/purchasing/suppliers) with open orders, and you can't [delete a received order](/docs/purchasing/the-po-lifecycle#why-cant-i-delete-this-order).
