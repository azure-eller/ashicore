...
| Unit conversion rate | You / system | Stocking units per sales unit, from 0.0001 through 99,999,999.9999 after four-decimal rounding. Ashicore derives compatible conversions; you enter incompatible conversions. |
