...
export function purchaseOrderDraftToPayload(
  ...
  return {
    ...
    shipContactName: draft.shipContactName ?? null,
    shipContactPhone: draft.shipContactPhone ?? null,
...
export function purchaseOrderEditDataToDraft(
  ...
  return {
    ...
    shipContactPhone: data.shipContactPhone,
...
export function purchaseOrderDetailToDraft(
  ...
  return {
    ...
    shipContactName: detail.shipContactName,
    shipContactPhone: detail.shipContactPhone,
