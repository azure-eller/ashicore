...
export function ReportsSection({
  ...
  return (
    <section id="reports" className="scroll-mt-24 rounded-lg border p-6">
      ...
      <FieldGroup>
        <div className="flex items-center justify-between gap-4 border-t py-3 first:border-t-0">
          <div>
            <FieldLabel>Daily Manufacturing Reports</FieldLabel>
          </div>
          <Switch
            ...
            onCheckedChange={(enabled) =>
              setFormState((current) => ({
                ...current,
                enabled,
                emailEnabled: enabled ? current.emailEnabled || true : current.emailEnabled,
              }))
            }
            aria-label="Enable daily manufacturing reports"
          />
        </div>

        <div className="grid gap-4 border-t py-4 md:grid-cols-2">
          <Field>
