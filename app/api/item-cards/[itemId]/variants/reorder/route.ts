...
import { reorderItemCardVariants, reorderItemCardVariantsSchema } from "@/lib/inventory/item-cards";
...
export const POST = apiHandler(async (request: Request, ctx: unknown) => {
  ...
  const data = await parseJsonBody(request, reorderItemCardVariantsSchema);
