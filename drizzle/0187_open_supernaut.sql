...
CREATE INDEX IF NOT EXISTS "manufacturing_order_ingredients_bom_component_id_idx" ON "manufacturing"."manufacturing_order_ingredients" USING btree ("bom_revision_component_id");--> statement-breakpoint
ALTER TABLE "settings"."organization_overhead_settings" DROP COLUMN IF EXISTS "overhead_pool";--> statement-breakpoint
ALTER TABLE "settings"."organization_overhead_settings" DROP COLUMN IF EXISTS "revenue_total";--> statement-breakpoint
ALTER TABLE "settings"."organization_overhead_settings" DROP COLUMN IF EXISTS "derivation";--> statement-breakpoint ALTER TABLE "inventory"."bom_revision_component_alternates" DROP CONSTRAINT IF EXISTS "bom_revision_component_alternates_quantity_check";--> statement-breakpoint
