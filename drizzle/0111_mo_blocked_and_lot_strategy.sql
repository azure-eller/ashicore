...
ALTER TABLE "manufacturing"."manufacturing_order_ingredients" ADD CONSTRAINT "manufacturing_order_ingredients_lot_strategy_check" CHECK (lot_strategy IN ('fifo','custom'));
