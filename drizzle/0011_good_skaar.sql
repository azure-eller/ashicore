...
ALTER TABLE "inventory"."items" ADD COLUMN "bom_mode" varchar(20);--> statement-breakpoint
...
ALTER TABLE "inventory"."bom_components" DROP COLUMN "uom";--> statement-breakpoint
ALTER TABLE "inventory"."bom_components" DROP COLUMN "sort_order";--> statement-breakpoint
ALTER TABLE "inventory"."bom_components" ADD CONSTRAINT "unique_bom_component" UNIQUE("item_id","component_id");--> statement-breakpoint
