...
CREATE TABLE "agent"."pending_requests" (
...
CREATE INDEX "agent_pending_requests_session_id_idx" ON "agent"."pending_requests" USING btree ("session_id");--> statement-breakpoint
CREATE INDEX "agent_pending_requests_turn_id_idx" ON "agent"."pending_requests" USING btree ("turn_id");--> statement-breakpoint
CREATE UNIQUE INDEX "agent_pending_requests_one_unresolved_per_session_uidx" ON "agent"."pending_requests" USING btree ("session_id") WHERE resolved_at IS NULL;--> statement-breakpoint
CREATE INDEX "agent_sessions_org_id_idx" ON "agent"."sessions" USING btree ("organization_id");--> statement-breakpoint
CREATE INDEX "agent_sessions_user_id_idx" ON "agent"."sessions" USING btree ("created_by_user_id");--> statement-breakpoint
CREATE INDEX "agent_sessions_updated_at_idx" ON "agent"."sessions" USING btree ("updated_at");--> statement-breakpoint
CREATE INDEX "agent_tool_calls_session_id_idx" ON "agent"."tool_calls" USING btree ("session_id");--> statement-breakpoint
CREATE INDEX "agent_tool_calls_turn_id_idx" ON "agent"."tool_calls" USING btree ("turn_id");--> statement-breakpoint
CREATE INDEX "agent_tool_calls_tool_name_idx" ON "agent"."tool_calls" USING btree ("tool_name");--> statement-breakpoint
CREATE INDEX "agent_turns_session_id_idx" ON "agent"."turns" USING btree ("session_id");--> statement-breakpoint
CREATE INDEX "agent_turns_org_id_idx" ON "agent"."turns" USING btree ("organization_id");--> statement-breakpoint
CREATE INDEX "agent_turns_started_at_idx" ON "agent"."turns" USING btree ("started_at");--> statement-breakpoint
CREATE INDEX "agent_uploads_session_id_idx" ON "agent"."uploads" USING btree ("session_id");--> statement-breakpoint
CREATE INDEX "agent_uploads_org_id_idx" ON "agent"."uploads" USING btree ("organization_id");--> statement-breakpoint
CREATE UNIQUE INDEX "agent_uploads_storage_key_uidx" ON "agent"."uploads" USING btree ("storage_key");--> statement-breakpoint
