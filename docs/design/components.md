...
| `ERPDataGrid` | [components/erp-data-grid.tsx](../../components/erp-data-grid.tsx) | Large operational lists backed by AG Grid; table chrome owns the white-cell surface, grey header, horizontal row rules, and resize grips without vertical column dividers |
...
| `StatusBlock` | [components/ui/status-block.tsx](../../components/ui/status-block.tsx) | Status states in grids, line tables, and inline pills; framed cells stay solid/uppercase while inline chips use the soft-tint palette |
